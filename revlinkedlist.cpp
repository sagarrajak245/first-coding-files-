...
// 1st method--- best recursive solution for reversing linked list........
node *rev(node *&head)
{
...
int main()
{
    ...
    print(node2);
    cout << endl;
    node *node3 = rev(node2);
    cout << "linked list after the  second rev is(using recursive approach) " << endl;
    print(node3);
